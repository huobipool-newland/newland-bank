module.exports = async function ({
    ...
    const { HETH } = await getNamedAccounts();

    let collateralFactor = '700000000000000000';
    let baseRatePerYear = '10000000000000000';
    ...
    await deploy('InterestMode_HETH', {
    ...
    let interestMode = await ethers.getContract('InterestMode_HETH');
    ...
    let cToken = await ethers.getContract('CHETH');
