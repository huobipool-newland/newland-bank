module.exports = async function ({
    ...
    const { HBTC } = await getNamedAccounts();
    ...
    await deploy('InterestMode_HBTC', {
    ...
    let interestMode = await ethers.getContract('InterestMode_HBTC');
    ...
    let cToken = await ethers.getContract('CHBTC');
